						...
						<table align="center" border="0" cellpadding="2" cellspacing="2" width="100%">
							...
							<tr>
								...
								<td class="content-panel-data">
									${LOGIN_CREDENTIALS.displayName}
								</td>
								<td class="content-panel-label">
									Age
								</td>
								<td class="content-panel-data">
									${LOGIN_CREDENTIALS.age}
								</td>		
								<td class="content-panel-label">
									Gender
								</td>
								<td class="content-panel-data">
									${LOGIN_CREDENTIALS.gender}
								</td>
							</tr>
							<tr>
								<td class="content-panel-label">
								...
								<td class="content-panel-data">
									${LOGIN_CREDENTIALS.dateOfStart}
								</td>
								<td class="content-panel-label">
									Duration
								</td>
								<td class="content-panel-data">
									<font class="content-panel-sub-label"><b>${LOGIN_CREDENTIALS.durationInWeeks}</b> weeks</font>
								</td>
							</tr>
							<tr>
								<td colspan="6" height="10"/>
							...
							<tr>
								...
								<td class="content-panel-data">
									${LOGIN_CREDENTIALS.consumedDurationInWeeksAsString} 
								</td>
							</tr>
							<tr>
								<td colspan="6">
									<table align="center" width="88%" cellpadding="0" cellspacing="0" class="form-border">
										<tr>
											<td height="10px" width="${LOGIN_CREDENTIALS.consumedDurationInPercentage == 0?'*':LOGIN_CREDENTIALS.consumedDurationInPercentage }%" style="background-color: #93CA3D;"><font style="font-size: 2px">&nbsp;</font></td>
											<td width="${LOGIN_CREDENTIALS.consumedDurationInPercentage == 100?'*': 100 - LOGIN_CREDENTIALS.consumedDurationInPercentage}%" style="background-color: #FFFFAA"><font style="font-size: 1px">&nbsp;</font></td>
										</tr>
									</table>
								</td>
							</tr>
