...
<table width="90%" align="center" cellspacing="2" cellpadding="2">
	...
	<tr>
		<td>
			<form method="post" action='<html:rewrite page="/admin/sendMail.do" />'>
														...
														<tr>
															...
															<td align="right" rowspan="2" nowrap>
																...
																<logic:notEqual name="message" property="senderId" value="reminder">
																	<a href="#" class="link" onclick="reply('${message.id}', '${LOGIN_CREDENTIALS.userId}', '${message.senderId}', '${message.subject}', '${message.priority}', '${message.rootMessageId}');">Reply</a>
																	&nbsp;&nbsp;&nbsp;&nbsp;
																	<a href='<html:rewrite page="/admin/markUnread.do?method=markUnread&id=${message.id}"/>' class="link">Mark Unread</a>
																</logic:notEqual>
																</logic:notEqual>
															</td>
														</tr>
