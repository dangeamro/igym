...
<script>
  ...
  function toggleNutrition(isAdmin)
  {
	...
	if(isAdmin)
	{
		document.getElementsByName('suggestedCalorieConsumption')[0].value="";
		document.getElementsByName('suggestedCalorieConsumption')[0].disabled = true;
		document.getElementsByName('protienPercentage')[0].value = "";
		document.getElementsByName('protienPercentage')[0].disabled = true;
		document.getElementsByName('carbohydratesPercentage')[0].value = "";
		document.getElementsByName('carbohydratesPercentage')[0].disabled = true;
		document.getElementsByName('fatPercentage')[0].value = "";
		document.getElementsByName('fatPercentage')[0].disabled = true;
		document.getElementsByName('otherPercentage')[0].value = "";
  ...
  function doCancel(){
  	document.customerForm.action = "<html:rewrite page='/admin/getSearchCustomer.do'/>";
...
<html:form action="/admin/addCustomer.do" method="post">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
							...
							<tr>
								...
								<td class="content-panel-data" width="25%" nowrap>
									<html:text property="userId" maxlength="20" styleClass="field-text-box" tabindex="1"/>&nbsp; 
									<font class="error"> 
							...
							<tr>
								...
								<td class="content-panel-data" nowrap>
									<html:password property="password" maxlength="40" styleClass="field-text-box"  tabindex="2"/>
							...
							<tr>
								...
								<td class="content-panel-data" nowrap>
									<html:password property="confirmPassword" maxlength="40" styleClass="field-text-box"  tabindex="3"/> &nbsp; 
									<font class="error">
							...
							<tr>
								...
								<td class="content-panel-data" nowrap>
									<html:text property="firstName" maxlength="50" styleClass="field-text-box" tabindex="5"/> &nbsp; 
									<font class="error">
								...
								<td class="content-panel-data" nowrap>
									<html:text property="emailAddress" maxlength="50" styleClass="field-text-box"  tabindex="11"/> &nbsp; 
									<font class="error">
							...
							<tr>
								...
								<td class="content-panel-data" width="" nowrap>
									<html:text property="lastName" maxlength="50" styleClass="field-text-box"  tabindex="6"/> &nbsp; 
									<font class="error"> 
							...
							<tr>
								...
								<td class="content-panel-data" nowrap>
									<Select name="gender" class="field-option"  tabindex="7">
							...
							<tr>
								...
								<td id="dobTd" class="content-panel-data" width="" nowrap>
									<html:text property="dob" maxlength="10" styleClass="field-text-box" tabindex="7" readonly="true" onfocus="javascript:scwShow(scwID('dob'),this)"/>
							...
							<tr>
								...
								<td class="content-panel-data" width="" nowrap>
									<html:text property="doj" maxlength="10" styleClass="field-text-box" tabindex="8" readonly="true" onfocus="javascript:scwShow(scwID('doj'),this)"/> 
							...
							<tr>
								...
								<td class="content-panel-data" width="" nowrap>
									<html:text property="dos" maxlength="10" styleClass="field-text-box" tabindex="9" readonly="true" onfocus="javascript:scwShow(scwID('dos'),this)"/> 
							...
							<tr>
								...
								<td class="content-panel-data" width="" nowrap>
									<html:text property="durationInWeeks" maxlength="3" styleClass="field-text-box" tabindex="10"/>
									...
									<fieldset id="nutritionControl" class="fieldset">
										...
										<table width="90%" align="center">
											...
											<tr>
												...
												<td class="content-panel-data" nowrap>
													<html:text size="2" maxlength="5" styleClass="field-text-box" tabindex="17" property="protienPercentage" onkeypress="return checkDecimal(this);"/>&nbsp;<font class="content-panel-sub-label">%</font>
												</td>
												<td class="content-panel-label" nowrap>
													carbohydrates
												</td>
												<td class="content-panel-data" nowrap>
													<html:text size="2" maxlength="5" styleClass="field-text-box" tabindex="18" property="carbohydratesPercentage" onkeypress="return checkDecimal(this);"/>&nbsp;<font class="content-panel-sub-label">%</font>
												</td>
											</tr>
											<tr>
												<td class="content-panel-label" nowrap>
												...
												<td class="content-panel-data" nowrap>
													<html:text size="2" maxlength="5" styleClass="field-text-box" tabindex="19" property="fatPercentage" onkeypress="return checkDecimal(this);"/>&nbsp;<font class="content-panel-sub-label">%</font>
												</td>
												<td class="content-panel-label" nowrap>
													Other nutrients
												</td>
												<td class="content-panel-data" nowrap>
													<html:text size="2" maxlength="5" styleClass="field-text-box" tabindex="20" property="otherPercentage" onkeypress="return checkDecimal(this);"/>&nbsp;<font class="content-panel-sub-label">%</font>
												</td>
											</tr>
											<tr>
												...
												<td colspan="2" class="content-panel-data" nowrap>
													<html:text property="suggestedCalorieConsumption" styleClass="field-text-box" tabindex="21" onkeypress="return checkDecimal(this);"/>
												</td>
											</tr>
										</table>
									</fieldset>
			...
			<table width="100%" cellpadding="0" border="0" cellspacing="0" align="center">
				<tr>
					<td align="center" height="25" class="add-panel-footer-button" nowrap>
						<input type="submit" value="Add" tabindex="22" onclick="javascript: doSubmit()">
