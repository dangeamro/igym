...
<form method="post" action='<html:rewrite page="/admin/sendUserMail.do" />'>
														...
														<tr>
															...
															<td align="right" rowspan="2" nowrap>
																<logic:notEqual name="LOGIN_CREDENTIALS" property="userId" value="${message.senderId}" >
																	<a class="link" style="cursor: hand;" onclick="reply('${message.id}', '${LOGIN_CREDENTIALS.userId}', '${message.senderId}', '${message.subject}', '${message.priority}', '${message.rootMessageId}');">Reply</a>
																	&nbsp;&nbsp;&nbsp;&nbsp;
																	<a href='<html:rewrite page="/admin/markUserMailUnread.do?method=markUnread&id=${message.id}&targetUserId=${TARGET_USER.userId}"/>' class="link">Mark Unread</a>
																</logic:notEqual>
															</td>
														</tr>
														<tr>
