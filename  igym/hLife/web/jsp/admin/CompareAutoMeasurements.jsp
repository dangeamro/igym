...
<script>
	function Automeasurements(){
			document.compareAuto.action="<html:rewrite page='/admin/getAutoStatusAndMeasurements.do' />";
...
<body>
<form name="compareAuto" action="<html:rewrite page='/admin/compareAutoStatusAndMeasurements.do'/>" method="post">
...
<table align="center" width="90%" border="0" cellpadding="0" cellspacing="0">
						...
						<table width="60%" align="center">
							<tr>
								...
								<td class="content-panel-label" nowrap>
									...
									&nbsp;&nbsp;
									<input type="submit" value="Generate Chart"  style="font-weight: bolder; width: 110;">
								</td>
							</tr>
						</table>
					</td>
	...
	<tr>
		<td align="center">
			<input type="button" value="Back To Measurements"  style="font-weight: bolder; width: 160;" onclick="javascript:Automeasurements();"/>
		</td>
	</tr>				
