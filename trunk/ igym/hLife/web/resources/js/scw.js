...
//******************************************************************************
    ...
    var scwBaseYear        = scwDateNow.getFullYear()-75;
...
'/* Calendar background */' +
'table.scw {background-color: #517298;}' +
'/* Drag Handle */' +
...
'/* Enabled Days */' +
'/* Week Day */' +
'td.scwCells {background-color: #E8F0FF;' +
'border: 0px solid #517298;' +
'color: #000000;}' +
  
'/* Day matching the input date */' +
'td.scwInputDate {background-color: #FEFFD7;' +
'color: #000000;' +
'border: 1px solid red;' +
'font-weight: bold;}' +
'/* Weekend Day */' +
'td.scwCellsWeekend {background-color: #E8F0FF;' +
'border: 0px solid #517298;' +
'color: #CC6666;}' +
'/* Day outside the current month */' +
'td.scwCellsExMonth {background-color: #E8F0FF;' +
'border: 0px solid #517298;' +
'font-weight: normal;' +
'color: #336699;}' +
'/* Today selector */' +
'td.scwFoot {background-color: #517298;' +
'color: #FFFFFF;' +
'font-weight: bold;}' + 
...
'/* Active cells */' +
'td.scwCells:hover,' +
'td.scwCellsHover {background-color: #66CCCC;' +
'cursor: hand;' +
'color: #000000;}' +
'/* Day matching the input date */' +
'td.scwInputDate:hover,' +
'td.scwInputDateHover {background-color: #FEFFD7;' +
'padding: 3px;' +
'margin: 0px;' +
...
'/* Weekend cells */' +
'td.scwCellsWeekend:hover,' +
'td.scwCellsWeekendHover {background-color: #66CCCC;' +
'cursor: hand;' +
'color: #000000;}' +
'/* Day outside the current month */' +
'td.scwCellsExMonth:hover,' +
'td.scwCellsExMonthHover {background-color: #E8F0FF;' +
'border: 0px solid #517298;' +
'font-weight: normal;' +
'color: #336699;}' +
'/* Today selector */' +
'td.scwFoot:hover,' +
'td.scwFootHover {color: #66CCCC;' +
'cursor: hand;' +
'font-weight: bold;}' +
'/* Disabled cells */' +
'/* Week Day */' +
...
//  Variables required by both scwShow and scwShowMonth
    ...
    function scwID(id)  {return document.getElementsByName(id)[0];}
...
// ***************************
    ...
    document.write(
     "<!--[if IE]>" +
        ...
        "</iframe>" +
     "<![endif]-->" +
     "<table id='scw' name='scw' class='scw'>" +
       "<tr class='scw'>" +
         "<td class='scw'>" +
           "<table class='scwHead' id='scwHead' name='scwHead' width='100%' " +
                    "cellspacing='0' cellpadding='0'>" +
            "<tr id='scwDrag' name='scwDrag' style='display:none;'>" +
                "<td colspan='4' class='scwDrag' " +
                    "onmousedown='scwBeginDrag(event);'>" +
                    "<div id='scwDragText' name='scwDragText'></div>" +
                "</td>" +
            "</tr>" +
            "<tr class='scwHead' >" +
                 "<td class='scwHead'>" +
                    "<input class='scwHead' id='scwHeadLeft' name='scwHeadLeft' type='button' value='<' " +
                            "onclick='scwShowMonth(-1);'  /></td>" +
                 "<td class='scwHead'>" +
                    "<select id='scwMonths' name='scwMonths' class='scwHead' " +
                            "onchange='scwShowMonth(0);'>" +
                    "</select>" +
                 "</td>" +
                 "<td class='scwHead'>" +
                    "<select id='scwYears' name='scwYears' class='scwHead' " +
                            "onchange='scwShowMonth(0);'>" +
                    "</select>" +
                 "</td>" +
                 "<td class='scwHead'>" +
                    "<input class='scwHead' id='scwHeadRight' name='scwHeadRight' type='button' value='>' " +
                            "onclick='scwShowMonth(1);' /></td>" +
                "</tr>" +
              "</table>" +
            "</td>" +
          ...
          "<tr class='scw'>" +
            "<td class='scw'>" +
              "<table class='scwCells' align='center'>" +
                "<thead>" +
                  "<tr><td class='scwWeekNumberHead' id='scwWeek_' name='scwWeek_'></td>");

    for (i=0;i<7;i++)
        document.write( "<td class='scwWeek' id='scwWeekInit" + i + "' name='scwWeekInit" + i + "'></td>");

    document.write("</tr>" +
                "</thead>" +
                "<tbody id='scwCells' name='scwCells' " +
                        "onClick='scwStopPropagation(event);'>");

    for (i=0;i<6;i++)
        {document.write(
                    "<tr>" +
                      "<td class='scwWeekNo' id='scwWeek_" + i + "' name='scwWeek_" + i + "'></td>");
         for (j=0;j<7;j++)
            {document.write(
                        "<td class='scwCells' name='scwCell_" + (j+(i*7)) +"' id='scwCell_" + (j+(i*7)) +
                        "'></td>");
            }
    ...
    if ((new Date(scwBaseYear + scwDropDownYears, 0, 0)) > scwDateNow &&
        ...
        {document.write(
                  "<tfoot class='scwFoot'>" +
                    "<tr class='scwFoot'>" +
                      "<td class='scwFoot' id='scwFoot' name='scwFoot' colspan='8'>" +
                      "</td>" +
                    "</tr>" +
                  "</tfoot>");
        }
