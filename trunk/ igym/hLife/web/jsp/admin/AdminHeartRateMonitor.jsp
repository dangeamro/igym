...
<script>
		...
		function getComparison()
		{
			...
			document.viewHeartRateMonitor.action= "<html:rewrite page='/admin/compareHeartRateMonitor.do?targetUserId=${TARGET_USER.userId}' />";
			document.viewHeartRateMonitor.submit();
		}
</script>

<body>
<form name="viewHeartRateMonitor" action="<html:rewrite page="/admin/getAddHeartRateMonitor.do" />" method="post">
...
<table align="center" width="80%" border="0" cellpadding="0" cellspacing="0">
			...
			<logic:notPresent name="heartRateMonitorForm" scope="request">
				...
				<tr>
					<td height="60" class="search-result-text-data" style="text-align: center;font-family: Arial; font-size: 13;">
						No Heart rate monitor entries available for this user.
					</td>
				</tr>
			</logic:notPresent>
			</table>
	...
	<tr>
		<td align="center">
			<input type="button" value="Comparison Monitor" style="font-weight: bold; width: 150;" onclick="getComparison()"/>
		</td>
	</tr>
