...
<table width="98%" align="center" cellspacing="2" cellpadding="2">
	...
	<tr>
		<td>
			<form method="post" action='<html:rewrite page="/user/deleteSentMails.do" />'>
				<input type="hidden" name="method" value="deleteSentMails" />
				...
				<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="mail-display-area">
					...
					<bean:define id="targetURL" toScope="request" value="user/getMail.do?method=getMail" type="java.lang.String" />
					<jsp:include flush="true" page="/jsp/common/SentItemsDisplay.jsp"></jsp:include>
					<tr>
						<td height="5"></td>
					</tr>
				</table>
