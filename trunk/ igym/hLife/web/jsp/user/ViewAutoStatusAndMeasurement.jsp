...
<script>
	...
	function compareProgress(){
		...
		document.getAutoStatusAndMeasurement.action="<html:rewrite page='/user/compareAutoStatusAndMeasurements.do'/>";
		document.getAutoStatusAndMeasurement.submit();
	}
</script>

<form name="getAutoStatusAndMeasurement" action="<html:rewrite page="/user/getStatusAndMeasurements.do" />" method="post">
...
<table align="center" width="95%" border="0" cellpadding="0" cellspacing="0">
	...
	<logic:greaterThan name="pageCount" value="1" scope="request">
		...
		<tr>
			<td align="center">
				<input type="submit" value="Compare Progress" onclick="compareProgress();"/><input type="submit" value="Manual Measurements"/>
			</td>
		</tr>
	</table>
</form>