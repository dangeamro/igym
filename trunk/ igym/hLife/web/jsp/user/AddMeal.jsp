...
function formatDate(vDate, vFormat){ 
  ...
  function chooseT(flag){
  	...
  	if(flag =="1"){
		...
		document.getElementById("TypeDiv1").style.display = "none";
		document.getElementById("TypeDiv2").style.display = "none";
		document.getElementById("TypeDiv3").style.display = "block";
		document.addMeal.mealType.value = "3";
	}
	...
	function doAddFood(){
		...
		for (i = 0; i < document.getElementsByName("itemlist")[0].options.length; i++) {
			if(document.getElementsByName("itemlist")[0].options[i].selected){
				if((++noOfItemsMoved) > 10)
				{
					alert('At most 10 food items can be moved at a time. For making more please select again');
					updateTotals();
					return;
				}
...
//				selectedgrid.addRow(foodId,gridString+"\t<IMG onclick=\"doDeleteFood("+foodId+")\" width=\"10\" height=\"10\" SRC=\"<html:rewrite page='/resources/images/Delete2.png'/>\" />");

			 			
				selectedgrid.addRow(selFoodId,gridString+"\t<IMG onclick=\"doDeleteFood("+selFoodId+","+index+")\" width=\"10\" height=\"10\" style=\"cursor:hand;\" style=\"cursor:hand;\" SRC=\"<html:rewrite page='/resources/images/delete.gif'/>\" />");
...
function updateTotals()
{
	...
	if(roundToTwo(dayTotalCal + totalCalories) > roundToTwo(document.getElementById("suggestedTotalCal").innerText))
		document.getElementById("dayTotalCal").className = "red";
	else
		document.getElementById("dayTotalCal").className = "green";

	if(roundToTwo(dayTotalPro + totalProtein) > roundToTwo(document.getElementById("suggestedTotalPro").innerText))
		document.getElementById("dayTotalPro").className = "red";
	else
		document.getElementById("dayTotalPro").className = "green";

	if(roundToTwo(dayTotalCar + totalCarb) > roundToTwo(document.getElementById("suggestedTotalCar").innerText))
		document.getElementById("dayTotalCar").className = "red";
	else
		document.getElementById("dayTotalCar").className = "green";

	if(roundToTwo(dayTotalFat + totalFat) > roundToTwo(document.getElementById("suggestedTotalFat").innerText))
		document.getElementById("dayTotalFat").className = "red";
	else
		document.getElementById("dayTotalFat").className = "green";
}
...
function doSubmit(){
  ...
  if(document.addMeal.mealType.selectedIndex == 1 && addedFood.length == 0)
  {
  	alert('You have not made any food entry. Please select at least one food item from the list on the left side.');
  	return;
  }
  var num=0;
  var foodIdList="";
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" width="95%" class="content-panel-display-area">
				...
				<tr>
					<td class="content-panel-h2" >
						<select name="mealType" onChange="chooseT(this.value);" class="field-option">
							<option value="2">Food Meal</option>
							<option value="1" >Supplement</option>
							<option value="3">*Manual Meal Entry</option>
						</select>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time
					...
					<td>
						<div id="TypeDiv1" >
							<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
								<tr>
									<td class="content-panel-label">MRP Scoops<font class="star">*</font></td>
									<td class="content-panel-data"><input type="text" name="mrpScoops" size="10" class="field-text-box">&nbsp; 
									<font class="error"> 
										<html:errors property="mrpScoops" /> 
									</font></td>
									<td class="content-panel-label">MRP Scoops Qty<font class="star">*</font></td>
									<td class="content-panel-data"><input type="text" name="mrpScoopsQty" size="10" class="field-text-box"  onkeypress="return checkDecimal(this);">&nbsp; 
									<font class="error"> 
										<html:errors property="mrpScoopsQty" /> 
									</font></td>
								</tr>
								<tr>
									<td class="content-panel-label">Metabolic Support Oil<font class="star">*</font></td>
									<td class="content-panel-data"><input type="text" name="msOil" size="10" class="field-text-box"  onkeypress="return checkDecimal(this);">&nbsp; 
									<font class="error"> 
										<html:errors property="msOil" /> 
									</font></td>
									<td class="content-panel-label">Water Amount<font class="star">*</font></td>
									<td class="content-panel-data"><input type="text" name="waterAmt" size="10" class="field-text-box" onkeypress="return checkDecimal(this);">&nbsp; 
									<font class="error"> 
										<html:errors property="waterAmt" /> 
									</font></td>
								</tr>
						 	 </table>
					 	</div>
								...
								<table width="100%" align="center" border="0">
									...
									<tr>
										...
										<td class="content-panel-label">
											<input type="button" value="I cannot find my food in the list" onClick="chooseT(3);" style="font-size:12px; color:red;  width: 200"/>
										</td>
								  		<!-- td class="content-panel-data">
								  	...
								  	<tr>
								  		<td>
									  		<fieldset>
												<table width="95%" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 5 0 5 0;">
													 <tr style="background-color: #BFBFBF;">
													 	<td width="*"></td>
													 	<td width="18%" class="content-panel-label">
													 		Calories 
													 	</td>
													 	<td width="18%" class="content-panel-label">
													 		Fat
													 ...
													 <tr>
													 	<td class="content-panel-label" nowrap>Actual Totals for this meal</td>
													 ...
													 <tr>
													 	...
													 	<td class="content-panel-label"><label id="suggestedTotalCal" class="blue">${SuggestedNitriSummary.suggestedCalorieConsumption }</td>
													 	<td class="content-panel-label"><label id="suggestedTotalFat" class="blue">${SuggestedNitriSummary.fatGms }</td>
													 	<td class="content-panel-label"><label id="suggestedTotalPro" class="blue">${SuggestedNitriSummary.protienGms }</td>
													 	<td class="content-panel-label"><label id="suggestedTotalCar" class="blue">${SuggestedNitriSummary.carbohydratesGms }</td>
													 </tr>
													 <tr>
													 	<td colspan="5" height="1" style="background-color: #BFBFBF;"></td>
													 </tr>
				...
				<tr>
					...
					<legend class="legend">Manual Food Entry</legend>
					...
					<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">		
							<tr>
								...
								<td class="content-panel-data"><input type="text" name="proteinAmt" size="10" class="field-text-box" onkeypress="return checkDecimal(this);"></td>
							</tr>
							<tr>
								...
								<td class="content-panel-label">Amount</td>
								<td class="content-panel-data"><input type="text" name="complexCarbsAmt" size="10" class="field-text-box" onkeypress="return checkDecimal(this);"></td>
							</tr>
							<tr>
								...
								<td class="content-panel-label">Amount</td>
								<td class="content-panel-data"><input type="text" name="fibrousCarbsAmt" size="10" class="field-text-box" onkeypress="return checkDecimal(this);"></td>
							</tr>
							<tr>
								<td class="content-panel-label">Metabolic Support Oil</td>
								<td class="content-panel-data"><input type="text" name="metabolicSuppOil" size="10" class="field-text-box" onkeypress="return checkDecimal(this);"></td>
								<td class="content-panel-label">Essential Fats</td>
								<td class="content-panel-data"><input type="text" name="esentialFats" size="10" class="field-text-box" onkeypress="return checkDecimal(this);"></td>
							</tr>
							<tr>
								<td class="content-panel-label">Condiments</td>
								<td class="content-panel-data"><input type="text" name="condimentsName" size="10" class="field-text-box"></td>
								<td class="content-panel-label">Amount</td>
								<td class="content-panel-data"><input type="text" name="condimentsAmt" size="10" class="field-text-box" onkeypress="return checkDecimal(this);"></td>
							</tr>
							<tr>
								<td class="content-panel-label">Sauce</td>
								<td class="content-panel-data"><input type="text" name="sauceName" size="10" class="field-text-box"></td>
								<td class="content-panel-label">Amount</td>
								<td class="content-panel-data"><input type="text" name="sauceAmt" size="10" class="field-text-box" onkeypress="return checkDecimal(this);"></td>
							</tr>
						</table>
						</fieldset>
						</div>
...
<table>
	...
	<tr>
		<td class="content-panel-footer">
			...
			<input type="button" value="Cancel" name="cancel" onClick="doCancel()" style="width: 50"/>
		</td>
	</tr>
</table>
</form>
